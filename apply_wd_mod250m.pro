...
Pro apply_wd_mod250m, agb_in_file, agb_out_file, type_file, wd_file, type_code, in_tl_x, in_tl_y, in_pix_size, xdim, ydim, mean_wd
	...
	for j=0ULL, ydim-1 do begin
		...
		if (count gt 0) then begin
			...
			for i=0ULL, count-1 do begin
				...
				cur_wd = get_wd_mod250m(wd_image, cur_long, cur_lat)
